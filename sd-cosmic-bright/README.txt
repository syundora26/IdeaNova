...
【宇宙モーション版について】
惑星の自転（WebGL）、輪を回る光の粒、惑星の周りの星のきらめき、背景の星空のスクロール連動と星雲の漂い、軌道を回る光点、工程の星座結線、ボタン等のマイクロインタラクションを追加しています。
惑星の自転用テクスチャ（images/planet-albedo.webp, planet-light.webp）は source/scripts/planet-textures.py で生成しています。
